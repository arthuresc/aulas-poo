    ...
    <main class="container bg-dark text-light py-4">
        <form class="col-10 form-group input-group d-flex justify-content-center mx-auto" method="post" action="add-todo.php">
            ...
            <div class="btn-group my-1 ml-2" role="group">
              ...
              <div class='col-8 my-2 p-1 d-flex justify-content-between align-items-center bg-darkness text-light mx-auto rounded'>
                <input class='mx-1 my-1 p-1 col-9 rounded bg-dark input-todo' value="teste" type='text'>
                <form class='btn-group' action='opt-todos.php' method='post'>
              ...
              <div class='col-8 my-2 p-1 d-flex justify-content-between align-items-center bg-darkness text-light mx-auto rounded'>
              <p class='mx-1 my-1 p-1 rounded' type='text'>HAhahahaha</p>
                <form class='btn-group' action='opt-todos.php' method='post'>
                    <button class='btn-warning btn btn-secondary' value='${reg["idTodos"]}' name='edit' type='submit'>Editar</button>
                    <button class='btn-danger btn btn-secondary' value='${reg["idTodos"]}' name='delete' type='submit'>Delete</button>
                </form>
